...
<body id="page-top">
  ...
  ?>
  <form  name="deleteT" id="deleteT" method="POST" action="../consultas/deleteT.php" enctype="multipart/form-data">
    ...
    <div class="form-group col-md-12">
      ...
      <input type="text"  style="border: 2px solid white;" class="form-control" id="recipient-name" name="recipient-name" value="<?php echo $fila['id_expediente']; ?>">
    </div>
    <div class="form-group col-md-8" >
      <input type="text"  style=" border: 2px solid white;" class="form-control" id="datos" name="datos" value="<?php echo utf8_encode($fila['nombre']), " ", utf8_encode($fila['paterno']), " ", utf8_encode($fila['materno']); ?>">
    </div>
      </div>
    </div>
